  ...
  return (
    <>
      ...
      <div ref={formRef} className="min-h-screen bg-transparent flex flex-col md:flex-row items-center justify-center px-6 md:px-16  py-12 relative overflow-hidden text-white">
        ...
        {/* Left Section */}
        <div className="md:w-1/2 text-center md:text-left z-10 mt-10 mb-10 md:mb-0">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-white">
        ...
        <form
          ...
          className="md:w-1/2 w-full bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl z-10 p-8 md:p-12 border border-cyan-400/20"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={name}>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border ${errors[name] ? "border-red-500" : "border-cyan-400/30"} focus:outline-none focus:ring-2 focus:ring-cyan-400 transition bg-black/30 text-white`}
                  placeholder={label}
                />
            ...
            <div className="md:col-span-2">
              <label className="block font-medium text-cyan-300 mb-1">Message</label>
              <textarea
                name="message"
                ...
                className={`w-full px-4 py-3 rounded-lg border ${errors.message ? "border-red-500" : "border-cyan-400/30"} focus:outline-none focus:ring-2 focus:ring-cyan-400 resize-none transition bg-black/30 text-white`}
              />
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className={`px-10 py-3 text-white text-lg font-semibold rounded-full bg-gradient-to-r from-cyan-400 to-indigo-500 hover:from-indigo-500 hover:to-cyan-400 shadow-lg transition transform hover:scale-105 active:scale-95 ${
