  ...
  const services = [
    {
      ...
      desc: 'Robust, scalable, and secure apps built for the world’s most popular platform.',
    },
    {
      icon: <FaApple className="text-3xl text-gray-700" />,
      title: 'iOS Development',
      desc: 'Elegant, high-performance apps for iPhones and iPads with native Swift/Obj-C.',
    },
    {
      icon: <FaTabletAlt className="text-3xl text-purple-600" />,
      title: 'Cross-Platform Apps',
      desc: 'React Native & Flutter apps for both Android and iOS from a single codebase.',
    },
    {
      icon: <FaPalette className="text-3xl text-pink-500" />,
      title: 'UI/UX Design',
      desc: 'Intuitive user interfaces and delightful experiences crafted for engagement.',
    },
    {
      icon: <FaSyncAlt className="text-3xl text-yellow-500" />,
      title: 'App Maintenance',
      desc: 'Ongoing support, version updates, and bug fixes to keep your app fresh.',
    },
    {
      icon: <FaCloudUploadAlt className="text-3xl text-blue-500" />,
      title: 'Backend Integration',
      desc: 'APIs, databases, and cloud systems that connect your app to the real world.',
    },
    {
      icon: <FaShieldAlt className="text-3xl text-red-600" />,
      title: 'Security & Encryption',
      desc: 'Data protection, secure login systems, and GDPR-compliant development.',
    },
    {
      icon: <FaSearch className="text-3xl text-indigo-600" />,
      title: 'App Store Optimization',
      desc: 'Boost visibility and installs through performance tuning and ASO strategies.',
    },
    {
      icon: <FaBug className="text-3xl text-amber-700" />,
      title: 'Testing & QA',
      desc: 'Automated and manual testing to ensure your app works flawlessly.',
    },
    {
      icon: <FaRocket className="text-3xl text-orange-600" />,
      title: 'Launch & Scaling',
      desc: 'We handle deployment and prepare your app to handle thousands of users.',
    },
  ];
    ...
    <>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 py-24 px-6 sm:px-10 lg:px-20">
          <h1 className="text-4xl md:text-5xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500 mb-10 transition-opacity duration-700">
            Mobile App Development
          </h1>

          <p className="max-w-3xl mx-auto text-center text-gray-700 text-lg md:text-xl mb-12 transition-opacity duration-700">
